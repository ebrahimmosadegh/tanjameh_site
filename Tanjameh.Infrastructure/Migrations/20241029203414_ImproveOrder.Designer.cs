...
namespace Tanjameh.Infrastructure.Migrations
{
    ...
    [Migration("20241029203414_ImproveOrder")]
    partial class ImproveOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.CustomerAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.CustomerOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CustomOrderId")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.EventLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CustomItemOrderId")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
                    ...
                    b.Property<decimal?>("ExchangeRateTime")
                        .HasPrecision(20, 4)
                        .HasColumnType("decimal(20,4)");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.Product", b =>
                {
                    ...
                    b.Property<int?>("LastCalculatedWeightId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Exist" }, "IX_Exist");

                    b.HasIndex(new[] { "Name" }, "IX_Names");

                    b.HasIndex(new[] { "Name" }, "IX_Names_Descending")
                        .IsDescending();

                    b.HasIndex(new[] { "Price", "OldPrice" }, "IX_Price");

                    b.HasIndex(new[] { "Price", "OldPrice" }, "IX_Price_Descending")
                        .IsDescending();

                    b.HasIndex(new[] { "Rating" }, "IX_Rating_Descending")
                        .IsDescending();

                    b.HasIndex(new[] { "UpdatedOnUtc" }, "IX_Update");

                    b.HasIndex(new[] { "UpdatedOnUtc" }, "IX_Update_Descending")
                        .IsDescending();
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.ProductVariant", b =>
                {
                    ...
                    b.HasIndex(new[] { "Colour" }, "IX_Color");

                    b.HasIndex(new[] { "Name" }, "IX_Names")
                        .HasDatabaseName("IX_Names1");

                    b.HasIndex(new[] { "Name" }, "IX_Names_Descending")
                        .IsDescending()
                        .HasDatabaseName("IX_Names_Descending1");

                    b.HasIndex(new[] { "BrandSize", "DisplaySizeText", "SizeId" }, "IX_Size");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.ShippingInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.CustomerAddress", b =>
                {
                    b.HasOne("Tanjameh.Core.Entities.Customer", "Customer")
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.OrderItem", b =>
                {
                    b.HasOne("Tanjameh.Core.Entities.CustomerOrder", "CustomerOrder")
                        .WithMany("OrderItems")
                        .HasForeignKey("CustomerOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tanjameh.Core.Entities.Package", "Package")
                        .WithMany("OrderItem")
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.ShippingInfo", b =>
                {
                    b.HasOne("Tanjameh.Core.Entities.CustomerOrder", "CustomerOrder")
                        ...
                        .HasForeignKey("Tanjameh.Core.Entities.ShippingInfo", "CustomerOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tanjameh.Core.Entities.ShoppingCartItem", b =>
                {
                    b.HasOne("Tanjameh.Core.Entities.ShoppingCart", "ShoppingCart")
                        .WithMany("Items")
